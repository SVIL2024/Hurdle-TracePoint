        ...
        for i, item in enumerate(testdataloader):
            ...
            if tracepoint:
                ...
                diagnostics.update(
                    ...
                    global_start_prob,
                    is_normal=str(video_label) == 'Normal',
...
if __name__ == '__main__':
    ...
    testdataset = UCFDataset(args.visual_length, args.test_list, True, label_map, return_spans=args.tracepoint)
    ...
    test(model, testdataloader, args.visual_length, prompt_text, gt, gtsegments, gtlabels, device, tracepoint=args.tracepoint)
